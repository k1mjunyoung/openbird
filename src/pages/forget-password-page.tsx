...
import { useRequestPasswordResetEmail } from "@/hooks/muatations/auth/use-request-password-reset-email";
...
export default function ForgetPasswordPage() {
  ...
  const {
    ...
    onSuccess: () => {
      toast.info("인증 메일이 정상적으로 발송되었습니다.", {
        position: "top-center",
      });
      setEmail("");
    },
